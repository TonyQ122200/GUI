...
if __name__ == '__main__':
    ...
    if helmet4.concussion_flag:     # keep checking this variable, when it is True a concussion is likely
        print('CONCUSSION ALERT!')
        helmet4.concussion_flag = False     # reset the variable to False
    """
